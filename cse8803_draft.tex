...
Thomas Lasko also related in an email that the method described here
was an approximation assuming that measurement frequency was
proportional to how volatile the thing being measured is, and that
this assumption is not true for all medical tests.  He referred to
another paper of his\cite{Lasko2015} for a more robust approach,
however, this is not used here.

\subsubsection{Gaussian Process Regression}

In order to condition the time-series data from the prior step to
address its irregularity and sparsity, Gaussian process regression was
used.  The method used here was precisely what was described in Lasko
\emph{et al.}\cite{Lasko2013} which itself is just the method
described in algorithm 2.1 of Rasmussen \&
