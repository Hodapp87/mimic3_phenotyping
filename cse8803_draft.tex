...
lead to greater understanding of conditions and treatments. My goal is
to implement this (particularly, the methods from Lasko \emph{et
  al.}\cite{Lasko2013}) in Hadoop/Spark and more generally on the
laboratory results in MIMIC-III.
\end{abstract}
